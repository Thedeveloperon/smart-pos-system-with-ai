...
const CashChangeDialog = ({
  ...
  const breakdown = buildChangeBreakdown(normalizedChange, availableCounts);
  ...
  const isFullyCovered = allocatedChange >= normalizedChange && normalizedChange > 0;
