...
const values = [
  { icon: Smartphone, text: "Works on Phone, Tablet, or Desktop" },
  { icon: Clock, text: "Setup in Minutes" },
  { icon: GraduationCap, text: "Minimal Training" },
  { icon: HardDriveDownload, text: "No Bulky Hardware" },
];
      ...
      <div className="flex flex-wrap justify-center gap-4 md:gap-8">
        {values.map((v, i) => (
          ...
          >
            ...
            <span className="text-foreground text-sm font-medium whitespace-nowrap">{v.text}</span>
          </motion.div>
        ))}
      </div>
    </div>
